...
export class MockLanguageModel implements LanguageModelV3 {
  ...
  private countToolResults(messages: LanguageModelV3Message[]): number {
  ...
  private async *generateMockStream(
    ...
    if (toolMessageCount === 1) {
      ...
      yield { type: "tool-input-delta", id: toolId, delta: args };
      yield { type: "tool-input-end", id: toolId };
      yield { type: "tool-call", toolCallId: toolId, toolName: "str_replace_editor", input: args };
